...
- [ ] **1.3** Интеграционный тест для `--title`
- [ ] **1.4** Интеграционный тест для `--prefix` и `--prefix-title`
- [ ] **1.5** Убрать fallback `target/debug/filterway` из `filterway_binary()`
...
- [ ] **3.1** Добавить `anyhow` в зависимости
- [ ] **3.2** Заменить `Errorize` на `anyhow::Context`, перевести main на `anyhow::Result`
